...
class Generator:
    ...
    def add_provider(self, provider):
        ...
        for method_name in dir(provider):
            ...
            randum_function = getattr(provider, method_name)

            if callable(randum_function):
                # add all randum method to generator
                self.set_formatter(method_name, randum_function)
