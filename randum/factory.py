...
from randum.config import AVAILABLE_LOCALES, DEFAULT_LOCALE, PROVIDERS
from randum.generator import Generator
from randum.utils.loading import list_module
...
class Factory:
    ...
    def create(
        ...
        if locale not in AVAILABLE_LOCALES:
            msg = f'Invalid configuration for randum locale `{locale}`'
