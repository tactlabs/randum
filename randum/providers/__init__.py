...
class BaseProvider:
    ...
    def random_choices(self, elements=('a', 'b', 'c'), length=None):
        ...
        :meth:`random_elements() <randum.providers.BaseProvider.random_elements>` which
    ...
    def numerify(self, text='###'):
        ...
        Under the hood, this method uses :meth:`random_digit() <randum.providers.BaseProvider.random_digit>`,
        :meth:`random_digit_not_null() <randum.providers.BaseProvider.random_digit_not_null>`,
        :meth:`random_digit_or_empty() <randum.providers.BaseProvider.random_digit_or_empty>`,
        and :meth:`random_digit_not_null_or_empty() <randum.providers.BaseProvider.random_digit_not_null_or_empty>`
    ...
    def bothify(self, text='## ??', letters=string.ascii_letters):
        ...
        Under the hood, this method uses :meth:`numerify() <randum.providers.BaseProvider.numerify>` and
        and :meth:`lexify() <randum.providers.BaseProvider.lexify>` to generate random values for number
