...
class Provider(AutomotiveProvider):
    ...
    .. |license_plate_unified| replace::
       :meth:`license_plate_unified() <randum.providers.automotive.es_ES.Provider.license_plate_unified>`

    .. |license_plate_by_province| replace::
       :meth:`license_plate_by_province() <randum.providers.automotive.es_ES.Provider.license_plate_by_province>`
    """
