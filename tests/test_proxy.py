...
class TestRandumProxyClass:
    """Test Randum proxy class"""
    ...
    def test_seed_classmethod(self):
        ...
        with patch('randum.generator.Generator.seed') as mock_seed:
    ...
    def test_seed_instance(self):
        ...
        with patch('randum.generator.Generator.seed_instance') as mock_seed_instance:
    ...
    def test_seed_locale(self):
        from randum.generator import random as shared_random_instance
    ...
    def test_single_locale_proxy_behavior(self):
        ...
        with patch('randum.proxy.Randum._select_factory') as mock_select_factory:
    ...
    def test_multiple_locale_proxy_behavior(self):
        fake = Randum(['de-DE', 'en-US', 'en-PH', 'ja-JP'])
    ...
    def test_multiple_locale_caching_behavior(self):
        fake = Randum(['de_DE', 'en-US', 'en-PH', 'ja_JP'])

        with patch('randum.proxy.Randum._map_provider_method',
            ...
            with patch.object(Randum, '_cached_name_mapping', create=True,
    ...
    @patch('randum.proxy.random.choice')
    @patch('randum.proxy.choices_distribution')
    def test_multiple_locale_factory_selection_no_weights(self, mock_choices_fn, mock_random_choice):
        ...
        with patch('randum.proxy.Randum._select_factory',
    ...
    def test_weighting_disabled_single_choice(self, mock_choices_fn, mock_choice_fn):
        fake = Randum(use_weighting=False)
        fake.first_name()
    ...
    def test_weighting_disabled_with_locales(self, mock_choices_fn, mock_choice_fn):
        ...
        fake = Randum(locale, use_weighting=False)
        fake.first_name()
    ...
    def test_weighting_enabled_multiple_choices(self, mock_choices_fn, mock_choice_fn):
        fake = Randum(use_weighting=True)
        fake.uri_path(deep=3)
