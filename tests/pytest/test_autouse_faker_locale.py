...
defined by the user, but an autouse ``randum_locale`` fixture was defined. In this
setup, the plugin's session level ``Randum`` instance will not be used, and each
test will instead generate a new instance using the value of ``randum_locale``.
